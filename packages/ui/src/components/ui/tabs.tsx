  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:border-border data-active:bg-card data-active:text-foreground dark:data-active:border-input dark:data-active:bg-input dark:data-active:text-foreground",
