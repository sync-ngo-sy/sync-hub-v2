...
worker_schedule           = "*/3 * * * *"
scheduler_service_account = "scheduler@sync-ngo-prod.iam.gserviceaccount.com"
...
services = {
  ...
  worker = {
    ...
    env = {
      ...
      SYNC_WORKER_SCHEDULER_SERVICE_ACCOUNT = "scheduler@sync-ngo-prod.iam.gserviceaccount.com"
      SYNC_WORKER_SCHEDULER_AUDIENCE        = "https://sync-hub-worker/sync-ngo-prod"
