...
that still reads In review to them — and it clears the Telling off the row with the Notification
and the email. Only a Telling the Candidate reached stays behind.
