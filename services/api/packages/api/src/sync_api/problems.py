...
MANATAL_NOT_CONFIGURED_PROBLEM_TYPE = f"{PROBLEM_TYPE_PREFIX}manatal-not-configured"
MANATAL_NOT_AUTHORIZED_PROBLEM_TYPE = f"{PROBLEM_TYPE_PREFIX}manatal-not-authorized"
