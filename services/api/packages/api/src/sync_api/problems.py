...
TENANT_SLUG_ALREADY_REGISTERED_PROBLEM_TYPE = f"{PROBLEM_TYPE_PREFIX}tenant-slug-already-registered"
RECRUITER_ONLY_PROBLEM_TYPE = f"{PROBLEM_TYPE_PREFIX}recruiter-only"
RECRUITER_INACTIVE_PROBLEM_TYPE = f"{PROBLEM_TYPE_PREFIX}recruiter-inactive"
TENANT_INACTIVE_PROBLEM_TYPE = f"{PROBLEM_TYPE_PREFIX}tenant-inactive"
ADMIN_ROLE_REQUIRED_PROBLEM_TYPE = f"{PROBLEM_TYPE_PREFIX}admin-role-required"
RECRUITER_NOT_FOUND_PROBLEM_TYPE = f"{PROBLEM_TYPE_PREFIX}recruiter-not-found"
TENANT_REQUIRES_AN_ADMIN_PROBLEM_TYPE = f"{PROBLEM_TYPE_PREFIX}tenant-requires-an-admin"
