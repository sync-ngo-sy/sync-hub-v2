...
AVATAR_TOO_MANY_PIXELS_PROBLEM_TYPE = f"{PROBLEM_TYPE_PREFIX}avatar-too-many-pixels"
...
TENANT_LOGO_TOO_MANY_PIXELS_PROBLEM_TYPE = f"{PROBLEM_TYPE_PREFIX}tenant-logo-too-many-pixels"
