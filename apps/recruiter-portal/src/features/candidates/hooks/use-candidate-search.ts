...
/**
 * The Candidate view re-runs the search that found them rather than reading a profile endpoint
 * that does not exist — a cache hit on the way in from the results, a real search on a cold link.
 */
